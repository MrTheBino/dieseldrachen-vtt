...
export class DieseldrachenItemSheetV2 extends HandlebarsApplicationMixin(ItemSheetV2) {
    #dragDrop // Private field to hold dragDrop handlers

    /** @inheritDoc */
    static DEFAULT_OPTIONS = {
        classes: ['dieseldrachen', 'sheet', 'item'],
        tag: 'form',
        position: {
            width: 600,
            height: 450
        ...
        dragDrop: [{
            ...
            dropSelector: '.dieseldrachen.item'
        }],
        window: {
            resizable: true,
            controls: [
    ...
    static PARTS = {
        form: {
            template: 'systems/dieseldrachen-vtt/templates/v2/item/item-meleeWeapon-sheet.hbs'
        },
        tabs: {
        ...
        description: {
            template: 'systems/dieseldrachen-vtt/templates/v2/partial-description.html',
            id: 'description'
        }
    }
   ...
   */
    ...
    _configureRenderParts(options) {
        ...
        let templatePath = `systems/dieseldrachen-vtt/templates/v2/item/item-${this.document.type}-sheet.hbs`;
